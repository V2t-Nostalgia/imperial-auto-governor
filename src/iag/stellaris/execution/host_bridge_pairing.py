...
def build_paired_host_bridge_archive(
    ...
    *,
    ...
    overlay_token = overlay_access_token.strip()
    if not overlay_token:
        raise HostBridgePairingError("游戏叠加层访问令牌为空。")
    ...
    try:
        with zipfile.ZipFile(source_archive, "r") as source:
            ...
            overlay["access_token_file"] = "secrets/overlay_access_token"
