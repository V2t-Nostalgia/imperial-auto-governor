...
COMMAND_SPECS = (
    ...
    ProtocolCommandSpec(
        ...
        group="ground_warfare",
        title="设置轨道轰炸姿态",
        wire_family_hex="d62d01000300",
        verification_state="live_verified",
        risk="destructive_state_change",
        required_target_fields=("source_fleet_object", "stance"),
        setup="选择获授权的军用舰队，并准备三种已验证轰炸姿态之一。",
        operator_check="确认舰队轰炸姿态与计划一致，且房间保持同步。",
        example_target={
            "source_fleet_object": "<FLEET_OBJECT_ID>",
            "stance": "selective",
        },
    ...
    ProtocolCommandSpec(
        ...
        group="ground_warfare",
        title="运输舰队登陆敌方殖民地",
        wire_family_hex="6f3301000300",
        verification_state="paired_capture",
        risk="destructive_state_change",
        required_target_fields=("source_fleet_object", "target_colony_object"),
        setup="选择获授权、未失踪且未交战的运输舰队和可达的交战国殖民地。",
        operator_check="确认运输舰队获得登陆指定殖民地的命令。",
        example_target={
            "source_fleet_object": "<TRANSPORT_FLEET_OBJECT_ID>",
            "target_colony_object": "<HOSTILE_COLONY_OBJECT_ID>",
        },
    ),
    ProtocolCommandSpec(
        action="recruit_army",
        ...
        setup="从最新存档核对己方陆军队列、物种、来源殖民地、招募空间站与资源。",
        operator_check="确认一支正确物种和类型的陆军进入指定殖民地队列。",
        example_target={
            "context_822c": 0,
            "army_build_queue_id": "<ARMY_BUILD_QUEUE_ID>",
            "army_type": "robotic_army",
            "species_id": "<SPECIES_ID>",
            "source_colony_object": "<SOURCE_COLONY_OBJECT_ID>",
            "recruitment_starbase_object": "<STARBASE_OBJECT_ID>",
        },
    ),
    ProtocolCommandSpec(
        action="repair_fleet",
...
OFFLINE_FIXTURE_TARGETS: dict[str, dict[str, Any]] = {
    ...
    "land_armies": {
        ...
        "target_colony_object": 26,
    },
    "recruit_army": {
        "context_822c": 0,
        "army_build_queue_id": 27,
        "army_type": "robotic_army",
        "species_id": 28,
        "source_colony_object": 29,
        "recruitment_starbase_object": 30,
    },
    "repair_fleet": {
        "context_822c": 0,
        "source_fleet_object": 21,
