...
class ApplicationModelProfile(BaseModel):
    ...
    inherit_model_from_application_id: str | None = Field(
        default=None,
    ...
    def validate_json_options(self) -> "ApplicationModelProfile":
        ...
        if self.inherit_model_from_application_id == self.application_id:
            raise ValueError("An Application cannot inherit its own model route.")
