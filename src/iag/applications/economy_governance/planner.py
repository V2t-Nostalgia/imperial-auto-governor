...
from iag.core.paths import vanilla_content_pack_root
from iag.stellaris.state.save_ingest import VALID_REVIEW_INTERVALS


CONTENT_PACK_ROOT = vanilla_content_pack_root()
CAPABILITIES_PATH = CONTENT_PACK_ROOT / "mappings" / "capabilities.json"
STRATEGY_PATH = CONTENT_PACK_ROOT / "prompts" / "stellaris_4_4_sources.md"
