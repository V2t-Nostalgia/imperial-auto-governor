...
from extract_game_state import extract_game_state, load_gamestate
from game_knowledge import enrich_snapshot_layout
from iag_supervisor import StaleSourceSaveError, execute_run
from planner import (
    CAPABILITIES_PATH,
    build_candidates,
    decision_request,
...
class AgentToolbox:
    ...
    def __init__(
        ...
        *,
        allow_execute: bool,
        trigger: str,
        execute_fn: Callable[[Path, Path], dict[str, Any]] = execute_run,
    ):
    ...
    def execute_prepared_construction(
        ...
        try:
            ...
            result = self.execute_fn(self.runs_root / actual_run_id, self.config_path)
