...
from game_knowledge import build_local_rules_context, enrich_snapshot_layout
...
from web_research import build_web_research_context
...
def run_cycle(
    ...
    *,
    ...
    plan = read_json(plan_path) if plan_path else call_model(config, request)
