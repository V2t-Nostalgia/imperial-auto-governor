...
from iag.stellaris.execution.packet.iag_building_upgrade_rewriter import (
    rewrite_building_upgrade_carrier,
)
from iag.stellaris.execution.packet.iag_building_replacement_rewriter import (
    rewrite_building_replacement_carrier,
)
from iag.stellaris.execution.packet.iag_packet_interceptor import (
    BUILD_HEAD,
    BUILD_STRING_TAG,
